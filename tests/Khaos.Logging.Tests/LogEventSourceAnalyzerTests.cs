...
using Khaos.Logging.Analyzers;

namespace Khaos.Logging.Tests;

/// <summary>
/// Verifies analyzer diagnostics for <see cref="Khaos.Logging.LogEventSourceAttribute"/> scenarios.
/// </summary>
...
""";
    ...
    private static async Task<ImmutableArray<Diagnostic>> AnalyzeAsync(string source)
    {
        ...
        var references = CompilationReferenceHelper.CreateReferences(typeof(Khaos.Logging.LogEventSourceAttribute));
        ...
        Assert.NotNull(compilation.GetTypeByMetadataName("Khaos.Logging.LogEventSourceAttribute"));
