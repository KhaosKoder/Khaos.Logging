...
namespace Khaos.Logging.Analyzers;
...
public sealed class LogEventSourceAnalyzer : DiagnosticAnalyzer
{
    ...
    public override void Initialize(AnalysisContext context)
    {
        ...
        {
            const string attributeMetadataName = "Khaos.Logging.LogEventSourceAttribute";
            const string attributeDisplayName = "global::Khaos.Logging.LogEventSourceAttribute";
