...
namespace Khaos.Logging.Serilog;
...
public static class ServiceCollectionExtensions
{
    ...
    public static IServiceCollection AddKhaosSerilogLogging(
    ...
    /// <returns>The service collection for chaining.</returns>
    public static IServiceCollection AddKhaosSerilogLoggingFromConfiguration(
        this IServiceCollection services,
        string configurationSection = "Logging:Serilog")
    {
        ...
        return services.AddKhaosSerilogLogging();
    }
