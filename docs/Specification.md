...
# Khaos.Logging – Enum-Driven Hierarchical Logging Spec (Final)
...
* **Runtime**: `Khaos.Logging.Runtime`
* **Source generator**: `Khaos.Logging.Generator`
* **Analyzer**: `Khaos.Logging.Analyzers`
...
* Runtime internals:
  ...
  * `Khaos.Logging.Internal`
* Generator implementation:

  * `Khaos.Logging.Generator`
* Analyzer implementation:

  * `Khaos.Logging.Analyzers`
...
File: `Khaos.Logging.Runtime`

```csharp
namespace Khaos.Logging;
...
namespace MyApp.Logging
{
    public sealed class AppLogger<T>
    {
        ...
        public AppLogger(ILogger<T> inner)
        {
            ...
            Startup = new Khaos.Logging.Internal.EventLogger(
                _inner,
                (int)LogEventIds.APP_Startup,
                "MyApp.APP.Startup");

            ReadConfiguration = new Khaos.Logging.Internal.EventLogger(
                _inner,
...
namespace MyApp.Logging
{
    public sealed class DbConnectionLogger<T>
    {
        ...
        internal DbConnectionLogger(ILogger<T> inner)
        {
            ...
            Open = new Khaos.Logging.Internal.EventLogger(
                _inner,
                (int)LogEventIds.DB_Connection_Open,
                "MyApp.DB.Connection.Open");

            Close = new Khaos.Logging.Internal.EventLogger(
                _inner,
...
namespace MyApp.Logging
{
    ...
    public sealed class DbPoolTimingLogger<T>
    {
        ...
        internal DbPoolTimingLogger(ILogger<T> inner)
        {
            ...
            Measurement = new Khaos.Logging.Internal.EventLogger(
                _inner,
                (int)LogEventIds.DB_Pool_Timing_Measurement,
                "MyApp.DB.Pool.Timing.Measurement");

            Count = new Khaos.Logging.Internal.EventLogger(
                _inner,
...
* Use Roslyn APIs to:
  ...
  1. Find enums with `Khaos.Logging.LogEventSourceAttribute`.
...
Assembly: `Khaos.Logging.Analyzers`.
